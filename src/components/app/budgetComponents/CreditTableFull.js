...
function createData(id, creditTitle, creditSumm, paidSumm, leftSumm, singlePayment, leftPayments) {
    return {id, creditTitle, creditSumm, paidSumm, leftSumm, singlePayment, leftPayments};
}

const rows = [
    createData("1", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("2", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("3", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("4", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("5", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("6", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("7", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("8", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("9", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("10", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("11", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("12", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
    createData("13", "Zakupy w Auchan", 2000, 200, 1800, 100, 18),
];
    ...
    return (
        ...
        >
            ...
            {numSelected > 0 ? (
                ...
                <Link to="/app/budget/dataCredit/add/">
